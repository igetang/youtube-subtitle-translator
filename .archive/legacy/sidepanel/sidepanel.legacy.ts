...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (message.action === 'initializeSidePanelUI') {
        ...
        // 🔧 优化：从Background的userPreferences中获取UI语言信息
            ...
            updateAllUI({
                ...
                settings: {
                    ...
                    targetLang: finalTargetLang,
                                      subtitleMode: userPreferences[StorageKeys.SETTINGS.SUBTITLE_MODE] || defaultSettings.subtitleMode,
                  translationApi: userPreferences[StorageKeys.SETTINGS.TRANSLATION_API] || defaultSettings.translationApi,
                  apiKey: userPreferences[StorageKeys.SETTINGS.API_KEY] || defaultSettings.apiKey,
                  serviceType: userPreferences[StorageKeys.SETTINGS.SERVICE_TYPE] || defaultSettings.serviceType,
                  membershipCredentials: userPreferences[StorageKeys.SETTINGS.MEMBERSHIP_CREDENTIALS] || defaultSettings.membershipCredentials,
                  customApiConfig: userPreferences[StorageKeys.SETTINGS.CUSTOM_API_CONFIG] || defaultSettings.customApiConfig,
                  openaiConfig: userPreferences[StorageKeys.SETTINGS.OPENAI_CONFIG] || defaultSettings.openaiConfig
                }
            });
