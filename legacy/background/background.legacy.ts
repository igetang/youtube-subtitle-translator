...
// 新的统一设置管理
import { UserPreferencesManager } from '../src/shared/storage/user-preferences-manager';
import { MigrationHelper } from '../src/storage/migration-helper';
// ✅ 已移除旧的GlobalSettings和VideoSpecificData导入，使用新架构的UserPreferences
// --- 语言处理工具 ---
...
// 🔄 新增：全局设置管理器初始化和数据迁移
const globalSettingsManager = UserPreferencesManager.getInstance();
